...
const Navbar = () => {
  ...
  return (
    ...
    <nav className={openMenu?'md:hidden bg-lilac h-screen w-1/2 fixed right-[-50%] transition ease-in-out duration-300 -translate-x-full':'md:hidden bg-lilac h-screen w-1/2 fixed right-[-50%] transition'}>
